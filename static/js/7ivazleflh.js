...
function CreateWhatsappChatWidget(option = {
    brandSetting: {
        ...
        borderRadius: "25",
        brandImg: "/images/travy_wa_icon.png",
        brandImgData: null,
        brandName: "Travy",
    ...
    function initWidget(){
        ...
        if(options.chatButtonSetting.ctaText){
            ...
            <div id="wa-widget-send-button">
                ...
                <div style="color: white; font-size: 14px; padding-right:8px; padding-left:4px;">${option.chatButtonSetting.ctaText}</div>
            </div>
        </div>`);
            ...
            <div class='wa-chat-box'>
                <div class='wa-chat-box-header'>
                    <div class="wa-chat-box-brand-container">
                        <img class='wa-chat-box-brand' onError='this.src= "/images/travy_wa_icon.png";' src='${option.brandSetting.brandImg}'/>
                    ...
                    <div class="wa-chat-bubble-close-btn"><img style="display: table-row" src="/images/Vector.png?574"></div>
                </div>
