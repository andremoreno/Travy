...
$(document).ready(function () {
  ...
  $(".why__progress").waypoint(
    function () {
      ...
      $(".why__progress_item").addClass("js-animation");
      this.destroy();
    },
    { offset: "80%" }
  );
...
var url = '/js/7ivazleflh.js'; var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = url; var options = {"enabled":true,"chatButtonSetting":{"backgroundColor":"#13C656","ctaText":"Chat Us","borderRadius":"25","marginLeft":"20","marginBottom":"20","marginRight":"20","position":"right"},"brandSetting":{"brandName":"Travy Consultant","brandSubTitle":"Availabe Now","brandImg":"/images/travy_wa_icon.png","welcomeText":"Hi there!\nHow can I help you?","messageText":"Hello, I have a question","backgroundColor":"#085E54","ctaText":"Chat Us","borderRadius":"25","autoShow":false,"phoneNumber":"628118285030"}}; s.onload = function() { CreateWhatsappChatWidget(options); }; var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(s, x);